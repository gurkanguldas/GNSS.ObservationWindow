...
public class PointTransform {
	public static double B, L, h;
	public static double Xs, Ys, Zs;
	public static double a, f;
	public static double Alfa, S, Zr;
	...
	public static void Referance_WGS84() 
	{
		a = 6378137.0;
		f = 1.0 / 298.257222101;
	}

	public static void Referance_BESSEL() 
	{
		a = 6377397.155;
		f = 1.0 / 299.1528128;
	}

	public static void Referance_HAYFORD()
	{
		a = 6378388.0;
		f = 1.0 / 297.0;
	}
